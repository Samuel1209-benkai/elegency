        ...
        <div className="my-3">
            ...
            <p className="flex  lg:space-x-44 ">
               <span>{items.price} XOF</span> 
                <button className="border p-1 rounded-lg bg-stone-300"> <img src="Elegency/heart.svg"></img></button>
            </p>
        </div>
        <button className="bg-yellow-700 p-2 px-24 rounded text-white text-sm mt-2"> COMMANDER</button>
        </div>)});
    ...
    return (<div className=" lg:px-60 pt-20 px-20 md:px-10  pb-10">
        ...
        <div className="flex justify-between  my-4">
            ...
            <button className="m-4">Vlisco</button>
                ...
                <div className=" absolute right-80 h-60 bg-blue-400 ">
        ...
        <div className="flex justify-center items-center mt-20 space-x-10" >
            <button className="border-4 rounded p-2 px-4 border-yellow-700 p-2 text-xl">1</button>
            <button className="border-4 rounded p-2 px-4 border-yellow-700 p-2 text-xl">2</button>
            <button className="border-4 rounded p-2 px-2 border-yellow-700 p-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ">
